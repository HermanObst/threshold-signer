...
Node configs are YAML files generated by `scripts/generate-keys.sh`. Key fields:
...
threshold-signer/
  ...
  scripts/
    generate-keys.sh       -- Generate Ed25519 keys and YAML configs
